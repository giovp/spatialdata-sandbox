...
##
# from https://www.10xgenomics.com/datasets/human-breast-cancer-ductal-carcinoma-in-situ-invasive-carcinoma-ffpe-1-standard-1-3-0
...
urls = [
    ...
    "https://cf.10xgenomics.com/samples/spatial-exp/1.3.0/Visium_FFPE_Human_Breast_Cancer/Visium_FFPE_Human_Breast_Cancer_molecule_info.h5",
...
subprocess.run("tar -xzf data/Visium_FFPE_Human_Breast_Cancer_spatial.tar.gz -C data", shell=True, check=True)
subprocess.run("rm data/Visium_FFPE_Human_Breast_Cancer_spatial.tar.gz", shell=True, check=True)
